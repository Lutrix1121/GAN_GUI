...
class GANTuner:
    ...
    def run_grid_search(self, param_grid, n_samples=500, epochs=1000, early_stop_patience=10):
        """
    ...
    def run_random_search(self, param_distributions, n_iter=10, n_samples=5, epochs=1000, early_stop_patience=10):
        """
    ...
    def visualize_results(self):
        ...
        for param in param_cols:
            ...
            plt.close()
'''
def search(classLabel, epoch, numIterations, latentDim, batchSize, learningRate, beta1, data_path=None, results_dir=None, search_type='grid', integer_columns=None):
    '''
